...
def tetrahedra(p1, p2, p3, p4, gmap):
	...
	gmap.sew_dart(2,tr1[0],tr2[0])
	gmap.sew_dart(2,tr1[2],tr3[0])
	gmap.sew_dart(2,tr1[4],tr4[0])

	gmap.sew_dart(2,tr2[2],tr3[5])
	gmap.sew_dart(2,tr3[2],tr4[5])
	gmap.sew_dart(2,tr4[2],tr2[5])
...
def cube(xsize = 5, ysize  = 5 , zsize = 5, center = [0,0,0], gmap = None):
	...
	gmap.sew_dart(2, msquares[0][0], msquares[1][1] )
	gmap.sew_dart(2, msquares[0][2], msquares[4][1] )
	gmap.sew_dart(2, msquares[0][4], msquares[3][1] )
	gmap.sew_dart(2, msquares[0][6], msquares[2][1] )

	# sew bottom square to lateral squares
	gmap.sew_dart(2, msquares[5][0], msquares[1][5] )
	gmap.sew_dart(2, msquares[5][2], msquares[2][5] )
	gmap.sew_dart(2, msquares[5][4], msquares[3][5] )
	gmap.sew_dart(2, msquares[5][6], msquares[4][5] )

	# sew lateral squares between each other
	gmap.sew_dart(2, msquares[1][2], msquares[2][7] )
	gmap.sew_dart(2, msquares[2][2], msquares[3][7] )
	gmap.sew_dart(2, msquares[3][2], msquares[4][7] )
	gmap.sew_dart(2, msquares[4][2], msquares[1][7] )
...
def holeshape(xsize = 5, ysize = 5, zsize = 5, internalratio = 0.5, gmap = None):
	...
	gmap.sew_dart(2, msquares[0][2], msquares[1][1] )
	gmap.sew_dart(2, msquares[1][4], msquares[2][3] )
	gmap.sew_dart(2, msquares[2][6], msquares[3][5] )
	gmap.sew_dart(2, msquares[3][0], msquares[0][7] )

	# sew upper squares with external lateral
	gmap.sew_dart(2, msquares[0][0], msquares[8][1] )
	gmap.sew_dart(2, msquares[1][2], msquares[9][1] )
	gmap.sew_dart(2, msquares[2][4], msquares[10][1] )
	gmap.sew_dart(2, msquares[3][6], msquares[11][1] )

	# # sew upper squares with internal lateral
	gmap.sew_dart(2, msquares[0][5], msquares[12][0] )
	gmap.sew_dart(2, msquares[1][7], msquares[13][0] )
	gmap.sew_dart(2, msquares[2][1], msquares[14][0] )
	gmap.sew_dart(2, msquares[3][3], msquares[15][0] )

	# sew lower squares between each other
	gmap.sew_dart(2, msquares[4][6], msquares[5][1] )
	gmap.sew_dart(2, msquares[5][4], msquares[6][7] )
	gmap.sew_dart(2, msquares[6][2], msquares[7][5] )
	gmap.sew_dart(2, msquares[7][0], msquares[4][3] )

	# sew lower squares with external lateral
	gmap.sew_dart(2, msquares[4][0], msquares[8][5] )
	gmap.sew_dart(2, msquares[5][6], msquares[9][5] )
	gmap.sew_dart(2, msquares[6][4], msquares[10][5] )
	gmap.sew_dart(2, msquares[7][2], msquares[11][5] )

	# sew lower squares with internal lateral
	gmap.sew_dart(2, msquares[4][5], msquares[12][4] )
	gmap.sew_dart(2, msquares[5][3], msquares[13][4] )
	gmap.sew_dart(2, msquares[6][1], msquares[14][4] )
	gmap.sew_dart(2, msquares[7][7], msquares[15][4] )

	# sew external lateral squares between each other
	gmap.sew_dart(2, msquares[8][7], msquares[9][2] )
	gmap.sew_dart(2, msquares[9][7], msquares[10][2] )
	gmap.sew_dart(2, msquares[10][7], msquares[11][2] )
	gmap.sew_dart(2, msquares[11][7], msquares[8][2] )

	# sew internal lateral squares between each other
	gmap.sew_dart(2, msquares[12][2], msquares[13][7] )
	gmap.sew_dart(2, msquares[13][2], msquares[14][7] )
	gmap.sew_dart(2, msquares[14][2], msquares[15][7] )
	gmap.sew_dart(2, msquares[15][2], msquares[12][7] )
